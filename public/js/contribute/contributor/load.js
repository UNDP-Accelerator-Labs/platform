...
import { initDropdowns, rmPin, addLanguage, copyToken, requestToken } from '/js/contribute/contributor/main.js'
...
async function DOMLoad () {
	...
	const { editable } = JSON.parse(d3.select('data[name="page"]').node()?.value || false)
