...
export function getContent (params = {}) { // THIS IS TO LOAD THE PADS, TEMPLATES, ETC
...
export function updateTab (value) { // TO DO: THIS IS NOT WORKING FOR SOME REASON WHEN SAVING A PINBOARD TITLE
