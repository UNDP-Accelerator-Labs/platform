          ...
          fetch(
            ...
            .then((data) => {
              ...
              if (data.results.length) {
                ...
                obj.found = true;
                obj.caption = `Location name${
                  locations.length !== 1 ? 's' : ''
                } found using <a href='https://opencagedata.com/credits' target='_blank'>OpenCage Geocoder</a> | &copy; <a href='https://www.openstreetmap.org/copyright' target='_blank'>OpenStreetMap contributors</a>`; // TO DO: TRANSLATE
              } else {
                obj.found = false;
                obj.caption = `No location was found for <strong>${l}</strong>.`; // TO DO: TRANSLATE
              }
